...
원하면 내가 추가로 이것도 Notion 문서로 만들어 줄게

- 🍺 Homebrew + Java 개발환경 완벽 세팅
- ☕ Mac에서 Java 버전 관리 (jenv vs sdkman)
- 🚀 Spring Boot 개발환경 (Java + Gradle + IntelliJ)
이건 주니어 Java 개발자들이 실제로 많이 쓰는 세팅이라

정리해두면 포트폴리오나 개발 환경 문서로도 좋습니다.
